...
from src.run import REGISTRY as run_REGISTRY
...
def my_main(_run, _config, _log):
    ...
    # run
    if "use_per" in _config and _config["use_per"]:     # per_run is the prioritized replay buffer
...
if __name__ == '__main__':
    ...
    parser.add_argument("--env-config", type=str, default='sc2custom', choices=['sc2custom', 'randomsc2custom'])
    parser.add_argument("--config", type=str, default='scvd', choices=['scvd', 'qmix_attn_sc2custom', 'updet', 'refil', 'roma', 'scvd_no_task_rep'])
    # parser.add_argument("--env_args.map_name", type=str, default='cn_series')
    ...
    map_name = parse_command(params, "env_args.map_name", config_dict['scenario'])
