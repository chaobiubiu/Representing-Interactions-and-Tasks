...
import torch as th
from src.utils.rl_utils import RunningMeanStd
import numpy as np
...
class NMAC(BasicMAC):
    ...
    def select_actions(self, ep_batch, t_ep, t_env, bs=slice(None), test_mode=False):
        ...
        chosen_actions = self.action_selector.select_action(qvals[bs], avail_actions[bs], t_env, test_mode=test_mode)       # t_env is used to decrease the epsilon in epsilon_greedy policy.
